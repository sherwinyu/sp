...
require.define("/lib/parser.js",function(require,module,exports,__dirname,__filename,process,global){/* parser generated by jison 0.4.2 */
...
require.define("/src/json2humon.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  Recurser = {
    ...
    isImplicitString: function(str) {
      return /^\w+[\w ]*$/.test(str) && /\w$/.test(str);
    },
    implicitString: function(str) {
      return "\"" + str + "\"";
    },
    json2humon: function(val, level, context) {
      var key, str, v;
      if (level == null) {
        level = 0;
      }
