describe "detail controller", ->
  describe "commitAndContinue", ->
    it "should insert a new node and focus on it!"
...
describe "content field", ->
  describe "focusOut", ->
    ...
    it "should it allow default to cancel changes?"
    it "should it allow default to unsaved changes?"
    it "should it allow default to save changes?"
    it "should it fall back to string parsing?"
